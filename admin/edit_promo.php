...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['image_url']) && $_FILES['image_url']['error'] == 0) {
        $target_dir = $_SERVER['DOCUMENT_ROOT'] . '/hokiraja/assets/images/promos/';
    ...
    <div class="card-body">
        <form action="edit_promo.php?id=<?php echo $promo_id; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img src="../assets/images/promos/<?php echo htmlspecialchars($promo['image_url']); ?>" alt="Gambar saat ini" width="200" class="img-thumbnail">
            </div>
            <div class="mb-3">
