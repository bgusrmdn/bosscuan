...
<div class="bg-dark border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="manage_games.php" class="list-group-item list-group-item-action bg-dark text-white <?php echo (in_array($current_page, ['manage_games.php', 'add_bulk_games.php', 'edit_game.php', 'add_provider.php', 'edit_provider.php', 'add_category.php', 'edit_category.php'])) ? 'active' : ''; ?>">
            <i class="fas fa-gamepad fa-fw me-2"></i>Manajemen Game
        </a>
        <a href="manage_users.php" class="list-group-item list-group-item-action bg-dark text-white <?php echo (in_array($current_page, ['manage_users.php', 'edit_user.php', 'view_user_banks.php', 'edit_user_bank.php'])) ? 'active' : ''; ?>">
            <i class="fas fa-users fa-fw me-2"></i>Manajemen User
        </a>
        <a href="manage_transactions.php" class="list-group-item list-group-item-action bg-dark text-white <?php echo ($current_page == 'manage_transactions.php') ? 'active' : ''; ?>">
