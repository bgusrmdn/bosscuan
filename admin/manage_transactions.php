                    ...
                    <?php if ($result && $result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="process_transaction.php?id=<?php echo $row['id']; ?>&action=approve&type=<?php echo $type_filter; ?>" class="btn btn-sm btn-success" onclick="return confirm('Anda yakin ingin MENYETUJUI transaksi ini?');">
                                        <i class="fas fa-check me-1"></i> Approve
                                    </a>
                                    <a href="process_transaction.php?id=<?php echo $row['id']; ?>&action=reject&type=<?php echo $type_filter; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin MENOLAK transaksi ini?');">
