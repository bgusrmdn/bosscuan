...
$admin_deposit_accounts_result = $conn->query("
    SELECT ada.id, ada.account_name, ada.account_number, pm.method_name, pm.method_type, pm.logo as method_logo, ada.min_deposit as acc_min_deposit, ada.max_deposit as acc_max_deposit, pm.method_code, ada.qris_image_url
    FROM admin_deposit_accounts ada
    JOIN payment_methods pm ON ada.method_code = pm.method_code
    WHERE ada.is_active = 1
                            ...
                            <form id="deposit-qris-form" action="process_deposit_non_api.php" method="POST"> <input type="hidden" name="channel_type" value="qris">
                                ...
                                <?php if (!empty($qris_static_info['qris_image_url'])): ?>
                                    <div class="text-center my-4">
                                        <img src="assets/images/qris/<?php echo htmlspecialchars($qris_static_info['qris_image_url']); ?>" alt="QRIS Code" class="img-fluid qris-image" style="max-width: 250px; border-radius: 5px;">
                            ...
                            <div class="accordion accordion-flush mt-4" id="bankDepositAccordion">
                                <div class="accordion-item bg-dark border-secondary">
                                    ...
                                    <div id="collapseNotesBank" class="accordion-collapse collapse" aria-labelledby="headingNotesBank" data-bs-parent="#bankDepositAccordion">
                                        <div class="accordion-body text-white-50">
                                            ...
                                            <ul>
                                                <li>Minimal deposit adalah IDR 10.000.</li>
                                ...
                                <div class="accordion-item bg-dark border-secondary" id="bank-status-accordion-item">
                                    ...
                                    <div id="collapseBankStatusBank" class="accordion-collapse collapse" aria-labelledby="headingBankStatusBank" data-bs-parent="#bankDepositAccordion">
                                        <div class="accordion-body text-white-50">
                                            <div id="bank-status-list" class="row row-cols-3 row-cols-md-4 g-2">
                                                <?php if (!empty($bank_status_list)): ?>
                                                    ...
                                                    ?>
                                                        <div class="col">
                                                            <div class="bank-status-item <?php echo $status_class; ?>">
                                                                ...
                                                                <span><?php echo htmlspecialchars($bank['method_name']); ?></span>
                                                                <small class="status-text"><?php echo htmlspecialchars($status_text); ?></small>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; ?>
                                                <?php else: ?>
                                                    <div class="col-12">
                                                        <p class="text-center text-muted">Tidak ada data status bank.</p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
