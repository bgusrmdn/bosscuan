...
<main class="container my-4">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            <div class="card bg-dark text-white border-secondary chat-card">
                <div class="card-header d-flex justify-content-between align-items-center chat-card-header">
                    <div>
                        ...
                        <small id="admin-status" class="text-muted">Mengecek status admin...</small>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function checkAdminStatus() {
            try {
                ...
                adminStatusEl.innerHTML = (data.status === 'online') ? '<i class="fas fa-circle text-success"></i> Admin Online' : '<i class="fas fa-circle text-danger"></i> Admin Offline';
            } catch (error) {
                adminStatusEl.textContent = 'Gagal cek status';
            }
        }
