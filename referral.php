...
$referral_link = $protocol . $domain_name . "/hokiraja/daftar.php?ref=" . htmlspecialchars($referral_code);
?>
        ...
        <div class="col-lg-10">
            <div class="card bg-dark text-white border-secondary">
                <div class="card-body p-3 p-md-4">
                    <div class="referral-nav nav nav-pills justify-content-center mb-4">
                        <button class="nav-link active" data-view="daftar">Daftar Anggota Referral</button>
                        <button class="nav-link" data-view="anggota">Anggota Referral</button>
                        <button class="nav-link" data-view="bonus">Bonus Referral</button>
                    </div>
